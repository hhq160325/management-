    ...
    <div>
      {data ? (
        <TableContainer component={Paper} className="dashboard-container">
                ...
                <TableRow key={orchid.id}>
                  ...
                  <TableCell align="center">
                    <Button
                      ...
                      color="primary"
                      className="edit-btn"
                      onClick={() => handleEditClick(orchid.id)}
                    >
                      <EditIcon />
                    </Button>
                    <Button
          ...
          <Dialog open={!!editOrchidId} onClose={() => setEditOrchidId(null)}>
            <DialogTitle>Edit Orchid</DialogTitle>
            <DialogContent>
              {editOrchidId && (
                <Editorchid
                  orchidId={editOrchidId}
                  onUpdate={handleEditorchid}
                />
              )}
            </DialogContent>
            <DialogActions>
              <Button onClick={() => setEditOrchidId(null)}>Cancel</Button>
            </DialogActions>
          </Dialog>
        </TableContainer>
      ) : (
